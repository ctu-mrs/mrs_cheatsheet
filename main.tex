        ...
        \begin{minipage}{0.47\textwidth}
          ...
          \begin{center}
            \scriptsize{
              ...
              \vspace{0.2em}
              \tiny Would You Like to Know More? \url{https://ctu-mrs.github.io/docs/api/uav_ros_api}
              \vspace{-1em}
            }
          \end{center}
        \end{minipage}
          ...
          \begin{center}
            \scriptsize{
              \begin{itemize}
                ...
                \item Make sure the \textbf{robot's} \texttt{/etc/hosts} contains the '\texttt{127.0.1.1 <robot's hostname>}' entry.
...
Eigen::Quaterniond        eig_quat        = AttitudeConverter(guaternion);
